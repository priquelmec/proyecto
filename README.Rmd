...
- [`R/`](https://github.com/priquelmec/proyecto/tree/main/R):
...
Launch the [`make.R`](https://github.com/priquelmec/proyecto/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/priquelmec/proyecto/blob/main/CONTRIBUTING.md).
